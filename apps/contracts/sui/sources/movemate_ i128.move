...
/// @notice Creates an `I128` from raw bits (for internal use).
public fun from_bits(bits: u128): I128 {
    I128 { bits }
}
...
public fun neg(x: &I128): I128 {
    ...
    I128 {
        bits: if (x.bits < U128_WITH_FIRST_BIT_SET) x.bits | (1 << 127)
        else x.bits - (1 << 127),
    }
}
...
public fun add(a: &I128, b: &I128): I128 {
    if (a.bits >> 127 == 0) {
        ...
        if (b.bits >> 127 == 0) {
            ...
            // B is negative
            if (b.bits - (1 << 127) <= a.bits)
                return I128 { bits: a.bits - (b.bits - (1 << 127)) }; // Return positive
        ...
        if (b.bits >> 127 == 0) {
            // B is positive
            if (a.bits - (1 << 127) <= b.bits)
                return I128 { bits: b.bits - (a.bits - (1 << 127)) }; // Return positive
...
public fun mul(a: &I128, b: &I128): I128 {
    if (a.bits >> 127 == 0) {
        ...
        if (b.bits >> 127 == 0) {
            ...
            // B is negative
            return I128 {
                bits: (1 << 127) | (a.bits * (b.bits - (1 << 127))),
            } // Return negative
        }
    } else {
        // A is negative
        if (b.bits >> 127 == 0) {
            // B is positive
            return I128 {
                bits: (1 << 127) | (b.bits * (a.bits - (1 << 127))),
            } // Return negative
        } else {
            // B is negative
            return I128 {
                bits: (a.bits - (1 << 127)) * (b.bits - (1 << 127)),
            } // Return positive
        }
    }
}
...
public fun div(a: &I128, b: &I128): I128 {
    if (a.bits >> 127 == 0) {
        ...
        if (b.bits >> 127 == 0) {
            // B is positive
            return I128 {
                bits: (1 << 127) | ((a.bits - (1 << 127)) / b.bits),
            } // Return negative
        } else {
            // B is negative
            return I128 {
